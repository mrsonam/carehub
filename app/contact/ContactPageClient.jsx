            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                >
                  ...
                  <h3 className="text-sm font-bold uppercase tracking-widest text-foreground/30 mb-2">
                    {item.title}
                  </h3>
                  <p className="text-xl font-black font-manrope text-foreground mb-1 break-all">
                    {item.value}
                  </p>
            ...
            >
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-center justify-between py-4 border-b border-outline-variant/5 last:border-0"
                  >
