...
/**
 * Shared sidebar chrome for desktop column and mobile drawer.
 * `onNavigate` runs after choosing a link (e.g. close mobile menu).
 * `headerEnd` — e.g. close button in the mobile drawer.
 */
